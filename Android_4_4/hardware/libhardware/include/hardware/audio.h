...
struct audio_hw_device {
	...
	int (*switch_audio_source)(struct audio_hw_device *dev, int source);

	int (*set_volume_index)(struct audio_hw_device *dev, int streamType, int index);

	int (*set_mute_state)(struct audio_hw_device *dev, int state);
	int (*set_navi_state)(struct audio_hw_device *dev, int state);
	int (*set_btphone_state)(struct audio_hw_device *dev, int state);
	int (*set_mic_mode)(struct audio_hw_device *dev, int mode);
};
