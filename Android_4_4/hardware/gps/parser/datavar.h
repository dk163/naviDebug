 ...
 *
 ******************************************************************************
 * $Id: datavar.h 107299 2015-11-30 14:58:41Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/PRODUCTS/libParser/tags/libParser_v1.04/datavar.h $
 *****************************************************************************/
...
public:
    ...
    void Set(double d)			                { m_type = R8;		m_value.d = d; }
    void Set(float f)			                { m_type = R4;		m_value.f = f; }
