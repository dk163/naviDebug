 ...
 *
 ******************************************************************************
 * $Id: std_types.h 101833 2015-09-08 15:30:50Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/hal/std_types.h $
 *****************************************************************************/
...
/*!
  ...
  Basic numeric data have been defined for usability and easy porting of the
  project to other targets. The idea is to have small types which provide
  information about the its range. These types are also known as the TCL SECS
...
{
    bool enabled;
    unsigned short recvPio;
    unsigned int hostGpio;
} TX_READY_CONF_t;
