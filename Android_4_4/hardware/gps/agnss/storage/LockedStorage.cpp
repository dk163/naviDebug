 ...
 *
 ******************************************************************************
 * $Id: LockedStorage.cpp 103715 2015-10-06 11:18:18Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/storage/LockedStorage.cpp $
 *****************************************************************************/
...
*/
bool CLockedStorage::append(unsigned char const * pData, size_t iData, uint16_t * const checksum/*=NULL*/)
{
    if(!pData || !iData)
        return false;
...
*/
bool CLockedStorage::set(unsigned char const * pData, size_t iData, uint16_t * const checksum/*=NULL*/)
{
    lock(); //LOCK
