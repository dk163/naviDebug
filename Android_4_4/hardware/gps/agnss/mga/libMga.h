 ...
 *
 *****************************************************************************
 * $Id: libMga.h 113580 2016-04-01 14:49:56Z marcel.baracchi $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/PRODUCTS/libMga/tags/1.05/src/libMga.h $
 *****************************************************************************/
...
#define LIBMGA_VERSION      "1.05"  //!< libMGA version
...
typedef struct
{
    ...
    int numofdays;                      //!< Number of requested days of Almanac Plus data needed (Legacy Offline data).
