 ...
 *
 ******************************************************************************
 * $Id: UbxMgaIniPosLlh.cpp 108350 2015-12-16 10:47:43Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/helper/UbxMgaIniPosLlh.cpp $
 *****************************************************************************/
...
/*! Constructor configuring the object. The parameters are forwarded to
    \ref CUbxMsg
*/
CUbxMgaIniPosLlh::CUbxMgaIniPosLlh(void * context, WRITE_FUNC_p pWrite, size_t maxMsg, bool autoClear /* = true */)
...
/*! Implements the purely virtual function of the base
    class
*/
bool CUbxMgaIniPosLlh::impl_writeUbxMsg()
{
    return writeUbxMgaIniPos(&_pos);
}

/*! Implements the purely virtual function of the base
    class
*/
TRI_STATE_FUNC_RESULT_t CUbxMgaIniPosLlh::impl_isExpectedAnswer(unsigned char const * buf, size_t size)
{
...
/*! Implements the purely virtual function of the base
    class
*/
void CUbxMgaIniPosLlh::impl_clearData()
{
    memset(&_pos, 0, sizeof(_pos));
}
