 ...
 *
 ******************************************************************************
 * $Id: helperTypes.h 108314 2015-12-15 18:08:12Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/helper/helperTypes.h $
 *****************************************************************************/
...
const time_t LEAP_SEC[] = {   78710400,    94608000 // 1972.06.30T00:00:00, 1972.12.31T00:00:00
...
#define UNIX_LEAP_SEC      (sizeof(LEAP_SEC)/sizeof(LEAP_SEC[0])) //!< Number of Leap seconds since Unix Epoch 1970.01.01T00:00:00
#define SRC_CREAT_TIME_SEC 1448928000LL       //!< Earliest possible time this software might be existing at 2015-12-01T00:00:00+00:00

// GPS and UTC time related (conversion) constants 
#define GPS_LEAP_SEC       (UNIX_LEAP_SEC-9)  //!< GPS leap second since 1980.1.6T00:00:00
#define GPS_EPOCH_SEC      315964800LL        //!< GPS Epoch in seconds since the Unix Epoch (this is mkgmtime(1980,1,6,0,0,0,0))
...
#define HELPER_ERR_ENTRY_NOT_ALLOWED     -6   //!< The processed data contains an valid entry which is not allowed in this context
#define HELPER_ERR_INVALID_MAGIC         -7   //!< The magic code of the processed data is wrong
#define HELPER_ERR_UNSUPPORTED_VER       -8   //!< The data format of the processed data has an unsupported version
#define HELPER_ERR_INVALID_ENTRY_NUM     -9   //!< The processed data contains an invalid number of entries
#define HELPER_ERR_ENTRY_TOO_LONG       -10   //!< The processed data contains an entry which is longer than supported
#define HELPER_ERR_ENTRY_TOO_SHORT      -11   //!< The processed data contains an entry which is shorter than supported
...
/*! Function pointer type which imitates the
    ...
    \return                  Number of bytes written on
                             ...
                             on failure.
*/
typedef ssize_t (*WRITE_FUNC_p) ( void const * context
