 ...
 *
 ******************************************************************************
 * $Id: UbxMgaIniTimeUtc.cpp 108350 2015-12-16 10:47:43Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/helper/UbxMgaIniTimeUtc.cpp $
 *****************************************************************************/
...
/*! Constructor configuring the object. The parameters are forwarded to
    \ref CUbxMsg
*/
CUbxMgaIniTimeUtc::CUbxMgaIniTimeUtc(void * context, WRITE_FUNC_p pWrite, size_t maxMsg, bool autoClear /* = true */)
...
/*! Implements the purely virtual function of the base
    class
*/
bool CUbxMgaIniTimeUtc::impl_writeUbxMsg()
{
    return writeUbxMgaIniTimeUtc(&_accTime);
}

/*! Implements the purely virtual function of the base
    class
*/
TRI_STATE_FUNC_RESULT_t CUbxMgaIniTimeUtc::impl_isExpectedAnswer(unsigned char const * buf, size_t size)
{
    TRI_STATE_FUNC_RESULT_t result=CALL_AGAIN;
    if(buf && size)
    {
        if( isUbxMessage(buf, size) > 0
        && size==16        // Has the size of an MGA-ACK message
...
/*! Implements the purely virtual function of the base
    class
*/
void CUbxMgaIniTimeUtc::impl_clearData()
{
    memset(&_accTime, 0, sizeof(_accTime));
}
