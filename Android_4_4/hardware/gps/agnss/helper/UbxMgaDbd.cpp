 ...
 *
 ******************************************************************************
 * $Id: UbxMgaDbd.cpp 103715 2015-10-06 11:18:18Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/helper/UbxMgaDbd.cpp $
 *****************************************************************************/
...
/*! Constructor configuring the object. The parameters are forwarded to
    \ref CUbxMsg
*/
CUbxMgaDbd::CUbxMgaDbd(void * context, WRITE_FUNC_p pWrite, size_t maxMsg, bool autoClear /* = true */)
