 ...
 *
 ******************************************************************************
 * $Id: AssistNowLeg.h 113481 2016-03-31 13:26:03Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/AssistNowLeg.h $
 *****************************************************************************/
...
private:
    ...
    TRI_STATE_FUNC_RESULT_t continueLegTransfer( unsigned char const *buf
                                               , size_t size);
