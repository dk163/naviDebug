...
#ifdef AIP_MODULE
typedef void (* gps_gyr_callback)(GpsGyrData* gyr_data);
typedef void (* gps_acc_callback)(GpsAccData* acc_data);
typedef void (* gps_pul_callback)(GpsPulData* pul_data);
#endif
...
#ifdef AIP_MODULE
    gps_gyr_callback gyr_cb;
    gps_acc_callback acc_cb;
    gps_pul_callback pul_cb;
#endif
} GpsCallbacks;
