...
public final class PowerManagerService extends IPowerManager.Stub
    ...
    // True if the device should stay on forcedly.
    private boolean mForceOn = true;
    ...
    private boolean goToSleepNoUpdateLocked(long eventTime, int reason) {
        ...
        // never goto sleep !
        if (mForceOn) {
            Slog.d(TAG, "goToSleepNoUpdateLocked: never goto sleep (eventTime=" + eventTime + ", reason=" + reason + ")");
            return false;
        }
