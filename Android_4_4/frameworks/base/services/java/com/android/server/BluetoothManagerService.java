...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (/*Old:Intent.ACTION_BOOT_COMPLETED.equals(action)*/
            		getChinatspIntentAction().equals(action)) {
                synchronized(mReceiver) {
    ...
    BluetoothManagerService(Context context) {
        ...
        IntentFilter filter = new IntentFilter(/*Old:Intent.ACTION_BOOT_COMPLETED*/getChinatspIntentAction());
    ...
    private String getChinatspIntentAction() {
		String version = SystemProperties.get("ro.build.product", "")
				.toLowerCase();
		if (version.contains("7p")) {
			return "com.chinatsp.aciton.END_WELCOME";
		} else {
