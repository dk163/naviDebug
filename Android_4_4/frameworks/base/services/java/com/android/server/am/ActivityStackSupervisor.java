...
public final class ActivityStackSupervisor {
    ...
    //[BUGFIX]-Add by kang,09/13/2018,44378,com.android.settings/.CryptKeeper
    private final String custom_0 = ".CryptKeeper";
    ...
    final int startActivityUncheckedLocked(ActivityRecord r,
        ...
        //[BUGFIX]-Add by kang,09/13/2018,44378,com.android.settings/.CryptKeeper
        if((null != r) && (null != r.info) && (null != r.info.targetActivity) 
            && (r.info.targetActivity.contains(custom_0))){
            Slog.i(TAG, "startActivityUncheckedLocked r.info.targetActivity:  " + r.info.targetActivity);
