...
static int usb_device_added(const char *devname, void* client_data) {
	...
	jstring jProductName = env->NewStringUTF(productName);
    jstring deviceName = env->NewStringUTF(devname);
    if (method_usbDeviceAdded == NULL) {
           ALOGE("TSP Can't find usb_device_added usbDeviceAdded");
    }else{
    	   env->CallVoidMethod(thiz, method_usbDeviceAdded,
            jProductName, deviceName, vendorId, productId, deviceClass,
...
int register_android_server_UsbHostManager(JNIEnv *env)
{
    ...
    method_usbDeviceAdded = env->GetMethodID(clazz, "usbDeviceAdded", "(Ljava/lang/String;Ljava/lang/String;IIIII[I[I)V");
    if (method_usbDeviceAdded == NULL) {
