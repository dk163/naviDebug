...
public class KeyEvent extends InputEvent implements Parcelable {
	...
	/** TSP */
	public static final int KEYCODE_TSP_NAVI = 223;
	public static final int KEYCODE_TSP_TEL = 224;
	public static final int kEYCODE_TSP_MODE = 225;
	public static final int KEYCODE_TSP_SOS = 226;
	public static final int KEYCODE_TSP_INFO = 227;
	public static final int KEYCODE_TSP_MEDIA = 228;
	public static final int KEYCODE_TSP_POWER = 229;
	public static final int KEYCODE_TSP_BAND = 230;
	public static final int KEYCODE_TSP_SET = 231;
	public static final int KEYCODE_TSP_SEEK_UP = 232;
	public static final int KEYCODE_TSP_SEEK_DOWN = 233;

	public static final int KEYCODE_TSP_RESERVED = 234;

    private static final int LAST_KEYCODE = KEYCODE_TSP_RESERVED;
