        ...
        VolumeController
{
    ...
    private enum StreamResources {
        BluetoothSCOStream(AudioManager.STREAM_BLUETOOTH_SCO,
                ...
                R.drawable.ic_audio_bt,
                false),
        RingerStream(AudioManager.STREAM_RING,           //VOLUME_TTS
                R.string.volume_icon_description_ringer,
                R.drawable.ic_audio_ring_notif,
                R.drawable.ic_audio_ring_notif_mute,
                false),
        VoiceStream(AudioManager.STREAM_VOICE_CALL,       //VOLUME_MEDIA
                R.string.volume_icon_description_incall,
                R.drawable.ic_audio_phone,
                R.drawable.ic_audio_phone,
                false),
        SystemStream(AudioManager.STREAM_SYSTEM,          //VOLUME_PHONE
                R.string.volume_icon_description_incall,
                R.drawable.ic_audio_phone,
                R.drawable.ic_audio_phone,
                false),
        NaviStream(AudioManager.STREAM_NAVI,               //VOLUME_NAVI
                R.string.volume_icon_description_incall,
                R.drawable.ic_audio_phone,
                R.drawable.ic_audio_phone,
                false),
