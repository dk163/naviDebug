...
public class RecoverySystem {
    ...
    public static void rebootWipeUserData(Context context) throws IOException {
        ...
        condition.block();
		//gaorenwei 20170810 add for factoryset interface start
		String factorySetPath = Settings.System.getString(context.getContentResolver(),"factoryst_exclude_path");
		if(!TextUtils.isEmpty(factorySetPath)){
			bootCommand(context, "--wipe_data\n--locale=" + Locale.getDefault().toString()+"\n--exclude_path="+factorySetPath);
			Settings.System.putString(context.getContentResolver(),"factoryst_exclude_path","");
		}else{
            bootCommand(context, "--wipe_data\n--locale=" + Locale.getDefault().toString());
		}
		//gaorenwei 20170810 add for factoryset interface end
    }
