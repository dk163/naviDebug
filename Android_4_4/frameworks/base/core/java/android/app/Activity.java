...
public class Activity extends ContextThemeWrapper
	...
	private void sendActivityStatus(String status) {
		Intent intent = new Intent("com.chinatsp.change.activity");
