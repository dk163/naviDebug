...
static jint
android_media_AudioSystem_switchAudioSource(JNIEnv *env, jobject thiz, jint source)
{
    return (jint) AudioSystem::switchAudioSource(source);
}

static jint
android_media_AudioSystem_setVolumeIndex(JNIEnv *env, jobject thiz, jint streamType, jint index)
{
    return (jint) AudioSystem::setVolumeIndex(streamType, index);
}

static jint
android_media_AudioSystem_setMuteState(JNIEnv *env, jobject thiz, jint state)
{
    return (jint) AudioSystem::setMuteState(state);
}

static jint
android_media_AudioSystem_setNaviState(JNIEnv *env, jobject thiz, jint state)
{
    return (jint) AudioSystem::setNaviState(state);
}

static jint
android_media_AudioSystem_setBtphoneState(JNIEnv *env, jobject thiz, jint state)
{
    return (jint) AudioSystem::setBtphoneState(state);
}

static jint
android_media_AudioSystem_setMicMode(JNIEnv *env, jobject thiz, jint mode)
{
    return (jint) AudioSystem::setMicMode(mode);
}
...
static JNINativeMethod gMethods[] = {
    ...
    {"switchAudioSource",   "(I)I",     (void *)android_media_AudioSystem_switchAudioSource},
    {"setVolumeIndex",   	"(II)I",    (void *)android_media_AudioSystem_setVolumeIndex},
    {"setMuteState",   		"(I)I",     (void *)android_media_AudioSystem_setMuteState},
    {"setNaviState", 		"(I)I", 	(void *)android_media_AudioSystem_setNaviState},
    {"setBtphoneState", 	"(I)I", 	(void *)android_media_AudioSystem_setBtphoneState},
    {"setMicMode", 			"(I)I", 	(void *)android_media_AudioSystem_setMicMode},
};
