...
//[BUGFIX]-Add by kang,06/13/2018,com.tencent.wecarnavi custom,33436
static int getprocname(pid_t pid, char *buf, size_t len);
static int parcelSize = -1;//[BUGFIX]-Add by kang,06/27/2018,add binde size
        ...
        bool canThrowRemoteException)
{
	...
	char *pWecarnavi = "com.tencent.wecarnavi";
    ...
    switch (err) {
        ...
        case FAILED_TRANSACTION:
            ...
            if(strncmp(pWecarnavi, process_name, strlen(pWecarnavi)) == 0){
				//ALOGE("getpid %d\n", getpid());
				ALOGE("parcel size = %d", parcelSize);
				ALOGE("getCallingPid %d ", IPCThreadState::self()->getCallingPid());
				ALOGE("custom %s ", process_name);
			}
			else{
        ...
        jint code, jobject dataObj, jobject replyObj, jint flags) // throws RemoteException
{
	...
	parcelSize = data->dataSize();//[BUGFIX]-Add by kang,06/27/2018,add binde size
