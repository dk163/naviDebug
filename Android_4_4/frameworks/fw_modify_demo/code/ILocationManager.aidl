...
interface ILocationManager
{
    ...
    void requestUbxUpdates(in IUbxInfoListener listener);
    void reportAcc(in LocAcceInfo accelerometerInfo);
    void reportGyr(in LocGyroInfo gryInfo);
    void reportPulse(in LocPulseInfo speedPulseInfo);
    void notifyUbxSpeed(in LocPulseInfo speedPulseInfo);
}
