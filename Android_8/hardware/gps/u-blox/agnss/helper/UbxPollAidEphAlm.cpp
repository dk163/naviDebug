 ...
 *
 ******************************************************************************
 * $Id: UbxPollAidEphAlm.cpp 104606 2015-10-21 13:28:37Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/helper/UbxPollAidEphAlm.cpp $
 *****************************************************************************/
...
unsigned char const CUbxPollAidEphAlm::_aidPoll[_STATE_END_][8] =
                    ...
                    , { 0xB5, 0x62, 0x0B, 0x30, 0x00, 0x00, 0x3B, 0xBC } }; //!< UBX-AID-EPH poll request
...
*/
bool CUbxPollAidEphAlm::hasData()
{
    return _hasAllData;
}
...
/*! Implements the purely virtual function of the base
    class
*/
TRI_STATE_FUNC_RESULT_t CUbxPollAidEphAlm::impl_isExpectedAnswer(unsigned char const * buf, size_t size)
{
