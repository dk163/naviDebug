 ...
 *
 ******************************************************************************
 * $Id: UbxPollAidEphAlm.h 103715 2015-10-06 11:18:18Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/helper/UbxPollAidEphAlm.h $
 *****************************************************************************/
...
class CUbxPollAidEphAlm : public CUbxMsg
{
    ...
    private: // Variables
        ...
        static unsigned char const
               _aidPoll[_STATE_END_][8];//!< Messages used to poll the receiver
        static size_t const
               _expNumMsgs;             //!< Expected number of messages per
                                     //!< item in \ref STATE_t
};
