 ...
 *
 ******************************************************************************
 * $Id: UbxAidIni.cpp 104606 2015-10-21 13:28:37Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/v3.30/gps/agnss/helper/UbxAidIni.cpp $
 *****************************************************************************/
...
/*! Constructor configuring the object. The parameters are forwarded to
    \ref CUbxMsg
*/
CUbxAidIni::CUbxAidIni(void * context, WRITE_FUNC_p pWrite, size_t maxMsg, bool autoClear /* = true */)
...
/*! Implements the purely virtual function of the base
    class
*/
bool CUbxAidIni::impl_writeUbxMsg()
{
    return writeUbxAidIni(&_accTime, _pos.valid?&_pos:NULL);
}
