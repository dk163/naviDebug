...
//the validy of this certificate is till 28.1.2028
...
const char mbedtls_globalsign_pem[] = GLOBALSIGN_ROOT_CA;
const size_t mbedtls_globalsign_pem_len = sizeof(mbedtls_globalsign_pem);
