...
static asn_per_constraints_t asn_PER_type_altitudeDirection_constr_2 GCC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_altUncertainty_constr_6 GCC_NOTUSED = {
