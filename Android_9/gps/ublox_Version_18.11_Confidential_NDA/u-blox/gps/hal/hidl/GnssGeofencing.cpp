    ...
    namespace gnss
    {
      namespace V1_0
      {
        namespace implementation
        {
          ...
          pthread_t
          GnssGeofencing::createThreadCb(const char *name, void (*start)(void *), void *arg)
          {
          ...
          Return<void>
          GnssGeofencing::addGeofence(int32_t geofenceId,
                                      ...
                                      uint32_t unknownTimerMs)
          {
            ...
            {
              mGnssGeofencingIface->add_geofence_area(geofenceId,
                                                      latitudeDegrees,
                                                      longitudeDegrees,
                                                      radiusMeters,
