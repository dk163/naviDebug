    ...
    namespace gnss
    {
      namespace V1_0
      {
        namespace implementation
        {
          ...
          GpsNiCallbacks GnssNi::sGnssNiCb = {.notify_cb = niNotifyCb,
          ...
          void GnssNi::niNotifyCb(GpsNiNotification *notification)
          {
            ...
            IGnssNiCallback::GnssNiNotification notificationGnss = {
              ...
              .requestorIdEncoding = static_cast<IGnssNiCallback::GnssNiEncodingType>(
          ...
          Return<void> GnssNi::respond(int32_t notifId,
