...
*/
#define BITS(a, b)                                                                                 \
  ((((MAX((U)(a), (U)(b)) - MIN((U)(a), (U)(b)) + 1) <= 0) ?                                       \
      (U)0x00000000 :                                                                              \
      ((MAX((U)(a), (U)(b)) - MIN((U)(a), (U)(b)) + 1) >= 32) ?                                    \
      (U)0xFFFFFFFF :                                                                              \
...
#define CLZ(x)                                                                                     \
  (((x)&BIT(31)) ?                                                                                 \
     ...
     ((x)&BIT(4)) ?                                                                                \
     27 :                                                                                          \
     ((x)&BIT(3)) ? 28 : ((x)&BIT(2)) ? 29 : ((x)&BIT(1)) ? 30 : ((x)&BIT(0)) ? 31 : 32)
...
#define CTZ(x)                                                                                     \
  (((x)&BIT(0)) ?                                                                                  \
     ...
     ((x)&BIT(27)) ?                                                                               \
     27 :                                                                                          \
     ((x)&BIT(28)) ? 28 : ((x)&BIT(29)) ? 29 : ((x)&BIT(30)) ? 30 : ((x)&BIT(31)) ? 31 : 32)
...
*/
#define NUMBITS(a) ((a < 0) ? 0 : (a == 1) ? 1 : (1 + LOGB((a)-1)))
...
//! Align Value
/*!
  This macro can be used to align sizes or addresses to a specific \a nByte
  boundary,
  where \a nByte must be of the form 2^k. E.g. ALIGN(foo,sizeof(U4)) rounds up
  \c foo
...
*/
#define ALIGN(val, nBytes) (((val) + ((nBytes)-1)) & (~((nBytes)-1)))
...
/*!
  ...
  \note does not work for literal constants or expressions, i.e. \a c should be
  an lvalue
...
/*!
  ...
  \note does not work for literal constants or expressions, i.e. \a u should be
  an lvalue
...
*/
#define READ_REG_BYTE(reg, ofs) *(((U1 *)&reg) + ((ofs)&0x3))
...
*/
#define READ_REG_HWORD(reg, ofs) *(((U2 *)&reg) + ((ofs)&0x1))
