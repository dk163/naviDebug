...
protected: // Functions
  ...
  static size_t process(void const *context, size_t source, unsigned char *buf, size_t size);
  ...
  static void errorOccurred(void const *context, int operation, ssize_t fdindex, int correrrno);
