...
/*! Default constructor
*/
CFuncMngr::CFuncMngr() : _func(NULL) {}
...
*/
CFuncMngr::CFuncMngr(CFunc *other) : _func(other) {}
...
*/
CFuncMngr::CFuncMngr(const CFunc &other) : _func(NULL) { *this = other; }
...
/*! Copy constructor taking control over a copy of the object managed by
    ...
    \param other           : The object under control of the argument
                             ...
                             if required
*/
CFuncMngr::CFuncMngr(const CFuncMngr &other) : _func(NULL) { *this = other; }
...
/*! Does this object have a function-pointer-object under control?
    \return                  true if there is such an object,
                             false otherwise
*/
bool CFuncMngr::isEmpty() { return (_func == NULL); }
...
*/
TRI_STATE_FUNC_RESULT_t CFuncMngr::passData(unsigned char const *data, size_t size)
{
  if (!_func)
    return FAIL;
