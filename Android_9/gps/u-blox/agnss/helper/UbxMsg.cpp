...
*/
CUbxMsg::CUbxMsg(void *context,
                 WRITE_FUNC_p pWrite,
                 size_t maxMsg,
                 bool autoClear /* = true */,
                 bool readyToSendDef /*= false*/)
  : _context(context), _write(pWrite), _dataSent(false), _readyToSend(readyToSendDef), _countMsg(0),
    _autoClear(autoClear), _readyToSendDef(readyToSendDef), _maxMsg(maxMsg)
{
}

/*! Destructor
*/
CUbxMsg::~CUbxMsg() { _context = NULL; }
...
/*! Returns if the object is ready to send data to the receiver or not
    ...
    \return                      true if data is stored in the object
                                 and false otherwise
*/
bool CUbxMsg::isReadyToSend() { return _readyToSend; }
...
/*! Returns if the object has already sent data to the receiver
    ...
    \return                      true if data has already been sent
                                 false otherwise
*/
bool CUbxMsg::hasSentData() { return _dataSent; }
...
/*! Set the readiness of the object to send
    ...
    \param readyToSend     : true if the object is ready to send, false
                             otherwise
*/
void CUbxMsg::setReadyToSend(bool readyToSend) { _readyToSend = readyToSend; }
...
*/
void CUbxMsg::resetCounter() { _countMsg = 0; }
