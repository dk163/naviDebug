...
/*! Constructor configuring the object. The parameters are forwarded to
    \ref CUbxMsg
*/
CUbxCfgNavX5::CUbxCfgNavX5(void *context,
                           WRITE_FUNC_p pWrite,
                           size_t maxMsg,
                           bool autoClear /* = true */)
  : CUbxMsg(context, pWrite, maxMsg, autoClear), _enableAidAck(false)
{
}
...
/*! Implements the purely virtual function of the base
    class
*/
void CUbxCfgNavX5::impl_clearData() { _enableAidAck = false; }

/*! Implements the purely virtual function of the base
    class
*/
bool CUbxCfgNavX5::impl_writeUbxMsg() { return writeUbxCfgNavX5(_enableAidAck); }
