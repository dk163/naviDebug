    ...
    namespace gnss
    {
      namespace V1_0
      {
        namespace implementation
        {
          ...
          AGpsRilCallbacks AGnssRil::sAGnssRilCb = {.request_setid = AGnssRil::requestSetId,
          ...
          Return<void> AGnssRil::setRefLocation(const IAGnssRil::AGnssRefLocation &aGnssRefLocation)
          {
            ...
            aGnssRefloc.u.cellID = {.type = static_cast<uint16_t>(cellID.type),
                                    .mcc = cellID.mcc,
                                    .mnc = cellID.mnc,
                                    .lac = cellID.lac,
                                    .cid = cellID.cid,
          ...
          Return<bool>
          AGnssRil::updateNetworkState(bool connected, IAGnssRil::NetworkType type, bool roaming)
          {
            if (mAGnssRilIface == nullptr)
            {
              ALOGE("%s: AGnssRil interface is unavailable", __func__);
            ...
            mAGnssRilIface->update_network_state(
              connected, static_cast<int>(type), roaming, nullptr /* extra_info */);
            return true;
          }
