 ...
 */
     ...
     */
            ...
            Return<void>
            setRefLocation(const IAGnssRil::AGnssRefLocation &agnssReflocation) override;
            Return<bool> setSetId(IAGnssRil::SetIDType type, const hidl_string &setid) override;
            Return<bool>
            updateNetworkState(bool connected, IAGnssRil::NetworkType type, bool roaming) override;
