 ...
 */
          ...
          void GnssBatching::locationCb(int32_t locationsCount, FlpLocation **locations)
          {
            ...
            {
              ALOGW("%s: Unexpected high location count: %d set to %d",
                    __func__,
                    locationsCount,
     ...
     */
            ...
            for (int iLocation = 0; iLocation < locationsCount; iLocation++)
            {
              ...
              {
                ALOGE("%s: Null location at slot: %d of %d, skipping",
                      __func__,
                      iLocation,
                      locationsCount);
                continue;
              ...
              {
                ALOGE("%s: Unrequested location type %d at slot: %d of %d, skipping",
                      __func__,
                      locations[iLocation]->sources_used,
                      iLocation,
                      locationsCount);
                continue;
              }
          ...
          void GnssBatching::acquireWakelockCb() { Gnss::acquireWakelockFused(); }

          void GnssBatching::releaseWakelockCb() { Gnss::releaseWakelockFused(); }
